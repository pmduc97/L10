  		...
  		<div class="col-md-10 content">
  			<div class="panel panel-info">
	            <div class="panel-heading">
	                <div class="panel-title">Chỉnh sửa thông tin cây xanh</div>
	            </div>  
	            <div class="panel-body" >
	                <form method="post" action=".">
	                    ...
	                    <form  class="form-horizontal" method="post" >                      
	                        ...
	                        <div id="div_id_date" class="form-group required">
	                            <label for="id_username" class="control-label col-md-4  requiredField"> Loại cây<span class="asteriskField">*</span> </label>
	                            <div class="controls col-md-8 ">
	                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="date" style="margin-bottom: 10px" type="text" />
	                            </div>
	                        </div>
	                        ...
	                        <div id="div_id_email" class="form-group required">
	                             <label for="id_email" class="control-label col-md-4  requiredField"> Tuyến đường<span class="asteriskField">*</span> </label>
	                             <div class="controls col-md-8 ">
	                        ...
	                        <div class="form-group"> 
	                            ...
	                            <div class="controls col-md-8 ">
	                                ...
	                                <input type="button" name="edit" value="Chỉnh sửa" class="btn btn-success" id="button-id-signup" />
	                            </div>
	                        </div>                            
	                    </form>
	                </form>
